...
var game_lost_button_texture = preload("res://scenes/third_level/Minefield/Assets/button_dead.png")
var game_won_button_texture = preload("res://scenes/third_level/Minefield/Assets/button_cleared.png")
